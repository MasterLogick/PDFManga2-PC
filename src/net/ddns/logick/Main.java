...
public class Main {
    ...
    private boolean isFullDownload = true;
    private boolean isToZipFile = false;
    private boolean isDivideEnabled = false;
    ...
    private boolean wasDividePanelEnabled = false;
    private boolean wasChapterSelectionPanelEnabled = false;
    ...
    private void initListeners() {
        ...
        toZipCheckbox.addActionListener(actionEvent -> {
            ...
            if (isToZipFile) {
                wasDividePanelEnabled = isDivideEnabled;
                wasChapterSelectionPanelEnabled = !isFullDownload;
                enableDivision();
                disableChildren(divisionCheckBoxPanel, divisionPanel);
            } else {
                disableDivision();
                disableChildren(onStartDisabledContainers);
                enableChildren(onCheckEnabledContainers);
                if (wasChapterSelectionPanelEnabled) enableChildren(chaptersPanel);
                if (wasDividePanelEnabled) enableDivision();
            }
        });
