...
public class Main {
    //todo fix chapter selection fields
        ...
        startChapterNumberTextField.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                try {
                    ...
                    ex.printStackTrace();
                    LOG.error(String.format(Language.get("message.NaN"), startChapterNumberTextField.getText()), ex);
        ...
        divisionCountTextField.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                try {
                    ...
                    ex.printStackTrace();
                    LOG.error(String.format(Language.get("message.NaN") + "\n", divisionCountTextField.getText()), ex);
        ...
        endChapterNumberTextField.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                try {
                    ...
                    ex.printStackTrace();
                    LOG.error(String.format(Language.get("message.NaN") + "\n", endChapterNumberTextField.getText()), ex);
